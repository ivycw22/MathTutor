...
<html>
    ...
    <body>
        ...
        <div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
          ...
          <p class="w3-center w3-large">Let's get in touch. Send me a message to schedule a lesson:</p>
          <div style="margin-top:48px">
            <p><i class="fa fa-map-marker fa-fw w3-xxlarge w3-margin-right"></i> Arlington, VA</p>
            <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone: 703-865-9161</p>
            <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email: ivycw22@gmail.com</p>
          </div>
        </div>
...
[].forEach.call(daysActive, function(i) {
	...
	Calendar.prototype.renderEvents = function (events, ele) {
		...
		if (events.length === 0) {
			...
			var span = createElement('span', '', 'No Appointments Available');
...
!function () {
	var data = [];
        ...
        <c:forEach items='${openAppts}' var='appt' varStatus='i'>
            var name = 'Available Appointment';
            var date = '${appt.date}';
            var time = '${appt.time}';
